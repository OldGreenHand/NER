...
Training: crf_learn mytemplate esp.train myclassifier

Testing: crf_test -m myclassifier -o test_result esp.testb

Evaluation: perl conll-eval.pl -d "\t" < test_result 
